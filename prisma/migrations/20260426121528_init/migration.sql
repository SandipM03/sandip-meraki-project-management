...
-- CreateEnum
CREATE TYPE "ProjectStatus" AS ENUM ('SCOPING', 'ACTIVE', 'REVIEW', 'DONE');

-- CreateEnum
CREATE TYPE "ClientStatus" AS ENUM ('ACTIVE', 'AT_RISK', 'COMPLETED');

-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('TASK_CREATED', 'TASK_UPDATED', 'TASK_COMPLETED', 'COMMENT_ADDED');
